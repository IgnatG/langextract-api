...
resp=$(curl -s -X POST "${API_BASE}/extract" \
  ...
  -d '{
    "raw_text": "AGREEMENT dated January 15, 2025 between Acme Corporation (Seller) and Beta LLC (Buyer) for the purchase of 500 widgets at $25 each, totalling $12,500. Payment terms: net 30 days. Governed by Delaware law.",
    "provider": "gpt-4o",
    "passes": 1,
